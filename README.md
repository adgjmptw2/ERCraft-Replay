...
최근 연구 결과는 [2026-09-26 진행 현황](docs/PROGRESS-20260926.md), 이후 작업 기준은 [실용화 로드맵](docs/PRACTICAL-ROADMAP.md)에 정리했습니다. [공통 품질 연구 모듈](research/quality/README.md)은 별도 실험 코드이며 기존 서비스에 자동 적용되지 않습니다.
...
**worker**
Windows 서비스의 FIFO 큐, 요청 제한, 결과 보존과 실패 상태 처리 관련 일부 소스입니다. 원본 파일을 획득하는 실행 연결부는 제외했습니다.
